...
{
    return (
        <div className="px-4 py-2.25 bg-background-dark space-x-2 flex grow max-w-125 items-center rounded-md max-sm:px-2 max-sm:py-1.5 max-sm:grow-0 max-sm:space-x-1.5 max-sm:bg-gray-500/70">
            ...
            <input className=' grow text-[15px] outline-none bg-transparent leading-5.5 placeholder:text-[#808080] max-sm:text-xs' placeholder='Search features, tutorials, etc.'/>
