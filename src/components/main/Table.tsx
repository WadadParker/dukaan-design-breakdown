...
const TableCardItem: React.FC<TableCardItemProp>=({orderId,successful,transactionID,refundDate,orderAmount,index})=>
{
    return (
        <tr >
        ...
        <table className=' w-full text-left border-collapse max-sm:table-fixed max-sm:w-full'>
          <thead className='max-sm:w-screen'>
            <tr className="bg-background-dark ">
                <th className='text-text py-2.5 px-3 font-medium bg-background-dark rounded-l text-sm max-sm:text-[8.5px] max-sm:px-0 max-sm:pl-1 max-sm:py-1.5 max-sm:w-10'>Order ID</th>
                <th className='text-text py-2.5 px-3 font-medium bg-background-dark text-sm max-sm:text-[8.5px] max-sm:px-0 max-sm:py-1.5 max-sm:w-11'>Status</th>
                <th className='text-text py-2.5 px-3 font-medium bg-background-dark text-sm max-sm:text-[8.5px] max-sm:px-0 max-sm:py-1.5 max-sm:w-14'>Transaction ID</th>
                <th className='text-text py-2.5 px-3 font-medium bg-background-dark text-sm max-sm:text-[8.5px] max-sm:px-0 max-sm:py-1.5 max-sm:w-16'>Refund date</th>
                <th className="text-text py-2.5 px-3 font-medium bg-background-dark rounded-r text-sm max-sm:text-[8.5px] max-sm:px-0 max-sm:pr-1 max-sm:py-1.5 max-sm:w-14 text-right">Order amount</th>
            </tr>
            </thead>
            <tbody>
